...
pub(crate) struct Socket {
    ...
    /// Watcher for the latest net report, fed by the net report actor.
    net_report: n0_watcher::Direct<Option<Report>>,
...
/// Reason for triggering a net report probe cycle.
...
impl EndpointInner {
    ...
    pub(crate) async fn bind(opts: Options) -> Result<Self, BindError> {
        ...
        let sock = Arc::new(Socket {
            ...
            direct_addrs,
            net_report: net_report_watchable.watch(),
            #[cfg(not(wasm_browser))]
            dns_resolver: dns_resolver.clone(),
